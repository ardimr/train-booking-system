...
func NewSeatRepository(db db.DBInterface) *SeatRepository {
...
// Implementation
func (q *SeatRepository) FindAvailableSeats(ctx context.Context, param model.AvailableSeatRequestParam) ([]model.AvailableSeat, error) {
...
func (q *SeatRepository) AddSeats(ctx context.Context, wagonId int64, numberOfRows int) error {
