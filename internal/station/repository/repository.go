...
func NewStationRepository(db db.DBInterface) *StationRepository {
...
// Implementation
func (q *StationRepository) GetStations(ctx context.Context, param model.StationRequestParam) ([]model.CityStation, error) {
...
func (q *StationRepository) AddStation(ctx context.Context, newStation model.NewStation) error {
...
func (q *StationRepository) DeleteStation(ctx context.Context, stationCode string) error {
	deleteStatement := `
	DELETE FROM
    travel_schedules.stations
	WHERE
